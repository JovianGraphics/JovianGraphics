...
enum class EuropaColorSpace : uint32
{
	GammaSRGB = 0,
	GammaP3 = 1000104001,
...
enum class EuropaPresentMode : uint32
{
	Immediate = 0,
	Mailbox = 1,
	FIFO = 2,
...
enum class EuropaSurfaceTransform : uint32
{
	Identity = 0x00000001,
	Rotate90 = 0x00000002,
